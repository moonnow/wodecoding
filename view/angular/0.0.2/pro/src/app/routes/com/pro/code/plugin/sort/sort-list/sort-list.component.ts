...
import { SortService } from '@com/pro/code/plugin/sort/sort.service';
...
export class SortListComponent implements OnInit {
  ...
  columns: SimpleTableColumn[] = [
    ...
    { title: '排序规则', index: 'sortRule', width: '100px' },
    {
      ...
      buttons: [
        {
          text: '编辑',
          click: (record: any, modal: any) => this.router.navigate([ '/pro/code/plugin/sort/edit/' + record['sortId'] ])
        },
        {
          text: '删除',
          type: 'del',
        ...
        {
          text: '详情',
          click: (record: any, modal: any) => this.router.navigate([ '/pro/code/plugin/sort/detail/' + record['sortId'] ])
        }
      ]
    }
  ];
  ...
  addSort() {
    this.router.navigate([ '/pro/code/plugin/sort/edit' ]);
  }

  upSort() {
    this.router.navigate([ '/pro/code/plugin/sort/edit/' + this.list[0]['sortId'] ]);
  }
  ...
  detailSort() {
    this.router.navigate([ '/pro/code/plugin/sort/detail/' + this.list[0]['sortId'] ]);
  }
