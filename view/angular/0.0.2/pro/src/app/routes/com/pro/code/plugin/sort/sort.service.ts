...
import { Sort } from '@com/pro/code/plugin/sort/sort';
import { SortQuery } from '@com/pro/code/plugin/sort/sort-query';
...
export class SortService {
  ...
  query(sortQuery: SortQuery) {
    this.parameter = new Parameter();
    this.parameter.action = this.toolService.getAll;
    return this.http.post(this.url + this.toolService.getUrl(this.parameter), sortQuery, this.toolService.httpOptions);
  }

  pagingQuery(rows: number, page: number, sortQuery: SortQuery) {
    this.parameter = new Parameter();
    this.parameter.action = this.toolService.paging;
    return this.http.post(this.url + this.toolService.getPagingUrl(this.parameter, rows, page), sortQuery, this.toolService.httpOptions);
  }
}
