...
import { QueryQuery } from '@com/pro/common/module/autocode/query/query-query';
...
export class QueryService {
  ...
  constructor(
    ...
    this.url = this.toolService.url + 'pro/common/module/autocode/query';
  }
