...
import { QueryService } from '@com/pro/code/plugin/query/query.service';
...
export class QueryListComponent implements OnInit {
  ...
  columns: SimpleTableColumn[] = [
    ...
    { title: '排序权重', index: 'weightOrder', width: '100px' },
    {
      ...
      buttons: [
        {
          text: '编辑',
          click: (record: any, modal: any) => this.router.navigate([ '/pro/code/plugin/query/edit/' + record['queryId'] ])
        },
        {
          text: '删除',
          type: 'del',
        ...
        {
          text: '详情',
          click: (record: any, modal: any) => this.router.navigate([ '/pro/code/plugin/query/detail/' + record['queryId'] ])
        }
      ]
    }
  ];
  ...
  addQuery() {
    this.router.navigate([ '/pro/code/plugin/query/edit' ]);
  }

  upQuery() {
    this.router.navigate([ '/pro/code/plugin/query/edit/' + this.list[0]['queryId'] ]);
  }
  ...
  detailQuery() {
    this.router.navigate([ '/pro/code/plugin/query/detail/' + this.list[0]['queryId'] ]);
  }
