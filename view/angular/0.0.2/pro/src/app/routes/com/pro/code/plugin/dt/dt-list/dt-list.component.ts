...
import { CodingService } from '@com/pro/code/plugin/coding/coding.service';
...
export class DtListComponent implements OnInit {
  ...
  columns: SimpleTableColumn[] = [
    ...
    { title: '项目名称', index: 'proName', width: '200px' },
    {
      ...
      buttons: [
        {
          text: '编辑',
          click: (record: any, modal: any) => this.router.navigate([ '/pro/code/plugin/dt/edit/' + record['dtId'] ])
        },
        {
          text: '删除',
          type: 'del',
        ...
        {
          text: '详情',
          click: (record: any, modal: any) => this.router.navigate([ '/pro/code/plugin/dt/detail/' + record['dtId'] ])
        },
        {
          text: '更多',
          children: [
  ...
  addDt() {
    this.router.navigate([ '/pro/code/plugin/dt/edit' ]);
  }

  upDt() {
    this.router.navigate([ '/pro/code/plugin/dt/edit/' + this.list[0]['dtId'] ]);
  }
  ...
  detailDt() {
    this.router.navigate([ '/pro/code/plugin/dt/detail/' + this.list[0]['dtId'] ]);
  }
